...
4.  Select the branch between Bus 4 and Bus 5 and change its parameters
    to:
...
2.  Create load House 2: Create a new bus and name it 'House 2' to the
...
1.  In the 'Schematic' tab change the name of the other load
